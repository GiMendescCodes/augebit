...
// Buscar dados de desempenho para o gráfico
$sql_avaliacoes = "
...
$sql_cursos = "SELECT cursos_atuais FROM avaliacoes_funcionarios WHERE nome_funcionario = ? ORDER BY id DESC LIMIT 1";
...
$cursos_atuais = [];
if ($row_cursos && !empty($row_cursos['cursos_atuais'])) {
    $cursos_atuais = json_decode($row_cursos['cursos_atuais'], true);
}
?>
...
<body>
    ...
    <div class="tudo">
        <div class="tudo1">
            <div class="sidebar">
                <div class="icon-circle"><img src="img/casa.png" alt="Home icon"></div>
                <a href="/augebit/justificativas/index.php" class="menu-item"><span class="icon notebook"></span></a>
                <a href="/augebit/RH/desempenho-cursos/pagina_exibicao.php<?= $id ?>" class="menu-item"><span class="icon cap"></span></a>
                <a href="/augebit/desempenho/visualizar.php" class="menu-item"><span class="icon chart"></span></a>
                <a href="/augebit/solicitacoes/index.php" class="menu-item"><span class="icon phone"></span></a>
            </div>
            <div class="perfil"><a class="person" href="/augebit/perfil/index.php"></a></div>
        </div>
