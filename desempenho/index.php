...
<body>
    <div class="fixo">
        ...
        <div class="sidebar">
            ...
            <a href="\augebit\justificativas\index.php" class="menu-item"><span class="icon docs"></span></a>
            ...
            <a href="\augebit\solicitacoes\index.php" class="menu-item"> <span class="icon calendario"></span> </a>
        </div>
    </div>
    <div class="tudo">
        <div class="header">
