<?php
$conn = new mysqli("localhost", "root", "", "semestral");
if ($conn->connect_error) {
    die("Conexão falhou: " . $conn->connect_error);
}

$sql = "SELECT id, data_escolhida, opcao, status FROM semestral ORDER BY id DESC LIMIT 6";
$result = $conn->query($sql);

$sqlFolga = "SELECT data_escolhida FROM semestral WHERE opcao = '' AND status = 'aceito' AND data_escolhida >= CURDATE() ORDER BY data_escolhida ASC LIMIT 1";
...
$sqlFerias = "SELECT data_escolhida FROM semestral WHERE opcao = 'Férias' AND status = 'aceito' AND data_escolhida >= CURDATE() ORDER BY data_escolhida ASC LIMIT 1";
