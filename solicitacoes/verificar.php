...
$sql = "SELECT solicitacoes.id, solicitacoes.data_escolhida, solicitacoes.mensagem, solicitacoes.opcao, solicitacoes.status, 
               funcionario.nome, funcionario.foto
        FROM solicitacoes 
        JOIN funcionario ON solicitacoes.id_funcionario = funcionario.id
        ...
        <div class="content-area">
            ...
            <div class="container">
                <div class="parte1">
                    ...
                    <?php
                    $countSql = "SELECT COUNT(*) as total FROM semestra WHERE status = 'pendente'";
